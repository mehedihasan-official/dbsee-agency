      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <div className="mt-8 inline-flex items-center gap-2 border border-white/10 rounded-lg px-3 py-2">
              <div className="flex flex-col items-center">
                <span className="text-[10px] text-white/40 leading-none">Google</span>
                <span className="text-xs font-bold text-white leading-none">Partner</span>
              </div>
        ...
        <div className="border-t border-white/5 pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-white/30 text-xs">
            Copyright © 2025 Mega Castle Co WLL | Trading as GOamplify | CR No. 94941 13 ·{" "}
