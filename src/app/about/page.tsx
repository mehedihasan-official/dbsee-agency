...
const clients = [
  ...
  "SUSHISAMBA",
  "Jannat Est.",
  "St Christopher's Brain Education",
  "S/CO سيبكو",
  "Traveller",
  "BINAA",
  "Shukur شكر",
...
export default function About() {
  return (
    <div style={{ backgroundColor: "#ffffff" }}>
      {/* ── HERO ── */}
      <HeroBanner title="About Our Marketing Agency" />
      ...
      <section className="py-16 px-4" style={{ backgroundColor: "#fff" }}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="font-heading font-bold text-gray-900 text-3xl mb-1">
            GOamplify Marketing Agency
          </h2>
          <p className="text-gray-500 text-sm mb-6">
            a division of Mega Castle Co W.L.L.
          </p>
          <p className="text-gray-600 text-sm leading-relaxed max-w-3xl mx-auto">
            We&apos;re a Bahrain-based team of strategists, creatives, and
            technicians who believe every piece of content should serve a
            purpose. For over a decade, we&apos;ve been helping businesses like
            yours achieve measureable results.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-4" style={{ backgroundColor: "#f8f9fa" }}>
        <div className="max-w-5xl mx-auto">
          <h2 className="font-heading font-bold text-gray-900 text-2xl text-center mb-10">
            Our Approach
          </h2>
          <p className="text-gray-600 text-sm leading-relaxed mb-6 text-center max-w-3xl mx-auto">
            Everything we do revolves around one core principle:{" "}
            <strong className="text-gray-900">
              your customer comes first.
            </strong>{" "}
            We dive deep into understanding your customers&apos; journey. From
            their first interaction with your brand to the moment they become
            loyal advocates. By mapping out this journey, we craft strategies
      ...
      <section className="py-20 px-4" style={{ backgroundColor: "#fff" }}>
        <div className="max-w-6xl mx-auto">
          <h2 className="font-heading font-bold text-gray-900 text-3xl text-center mb-3">
            Our Team
          </h2>
          <p className="text-gray-500 text-sm text-center mb-12">
            We&apos;re not your typical agency folks. We&apos;re a collection of
            experts passionate about making a meaningful impact on your
            business.
          </p>
      ...
      <section className="py-16 px-4" style={{ backgroundColor: "#f8f9fa" }}>
        <div className="max-w-6xl mx-auto">
          <p className="text-xs font-bold uppercase tracking-widest text-center text-gray-500 mb-2">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 lg:grid-cols-6 gap-4">
            {clients.map((client, i) => (
              ...
              >
                <span className="text-gray-700 font-semibold text-xs text-center leading-tight">
                  {client}
                </span>
              </div>
            ))}
      ...
      <section className="py-16 px-4" style={{ backgroundColor: "#fff" }}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-500 text-sm leading-relaxed">
            Because we believe that marketing should be more than just pretty
            campaigns or blind ad spend. We&apos;re driven by the success
            stories of our clients. Fueled by the tangible results, our
            strategies produce and inspired by the relationships we build along
            the way. Find your partner. Find your purpose.
          </p>
        </div>
      </section>
      ...
      <section
        ...
        style={{
          background:
            "linear-gradient(135deg, #0d0d6b 0%, #1a1aad 60%, #2525c9 100%)",
        }}
      >
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-blue-200 text-sm mb-8">
            If you&apos;re looking for a partner who puts your customers at the
            centre of everything and believes every action should have a clear
            purpose, let&apos;s connect. We&apos;d love to dive into your
            customer journey and discover how we can drive real results
            together.
          </p>
          <Link
            href="/request-a-call"
