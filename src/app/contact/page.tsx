    ...
    <div style={{ backgroundColor: "#ffffff" }}>
          ...
          <div className="relative lg:pl-8 mt-8 lg:mt-0">
            ...
            >
              <p className="text-white text-sm italic leading-relaxed mb-3">
                &ldquo;Many a small thing has been made large by the right kind
                of advertising.&rdquo;
              </p>
      ...
      <section className="py-16 px-4" style={{ backgroundColor: "#fff" }}>
        <div className="max-w-xl mx-auto text-center">
          ...
          <h2 className="font-heading font-bold text-gray-900 text-3xl mb-8">
            Engage With Us
          </h2>
