 ...
 *
 * Promotional page featuring special package offers.
 * Users can select from preset packages or inquire about custom options.
 *
 * Features:
 ...
 *
 * @file Limited time offer/promotional page
 * @author DBSEE Agency
 * @page /limited-time-offer
 */
...
/**
 * International country codes with phone dial prefixes
 * Used for phone number formatting in form submissions
 */
const COUNTRY_CODES = [
        ...
        <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h2
              ...
              style={{ fontSize: "2rem", lineHeight: 1.2, color: "#4fc3f7" }}
            >
              The Businesses That Show Up Now, Win Later.
            </h2>

            <p className="text-gray-400 text-sm leading-relaxed mb-8 max-w-lg">
              Your competitors have stopped advertising. Your audience is glued
              to their screens. This is the lowest-cost, highest-attention
              window your business may ever get.
            </p>
        ...
        <div className="max-w-5xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div>
            ...
            <div className="text-gray-500 text-sm">
              More visibility for brands that advertise during a downturn.
            </div>
          </div>
          <div>
            <div
            ...
            <div className="text-gray-500 text-sm">
              More growth through our own meta-amplify.com fans.
            </div>
          </div>
          <div>
            <div
            ...
            <div className="text-gray-500 text-sm">
              Stay Visible Package — BD 600 per month management.
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed mb-4">
              Right now, most businesses in Bahrain have paused their marketing.
              No new content. No ads running. No presence online.
            </p>
            <p className="text-gray-400 text-sm leading-relaxed mb-4">
              They think they&apos;re being cautious. But they&apos;re actually{" "}
              <span className="text-white font-semibold">
                handing market share to whoever has the courage to keep showing
                up.
              </span>
            </p>
            <p className="text-gray-400 text-sm leading-relaxed">
              Your customers haven&apos;t stopped scrolling. They&apos;re
              scrolling{" "}
              <span className="text-white font-semibold">more than ever,</span>{" "}
              looking for updates, looking for answers, looking for normality.
              The businesses they see during this time are the ones they&apos;ll
              choose when things recover.
            </p>
          </div>
          <div className="flex items-start">
            <div className="bg-gray-900 border border-gray-800 rounded-xl p-6 w-full">
              <p
                ...
                style={{ color: "#4fc3f7" }}
              >
                Every day your business is silent, your competitors — the ones
                still showing up — are filling the space you left behind. And
                that space gets harder to reclaim the longer you wait.
              </p>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-20">
          ...
          <div className="space-y-8">
            {[
              ...
              },
              {
                ...
                company:
                  "McDonald's retreated. Taco Bell and Pizza Hut surged.",
              ...
              <div key={i} className="flex gap-6">
                <div
                  ...
                  style={{ backgroundColor: "#2979ff", minHeight: "80px" }}
                />
                <div>
          ...
          <p className="text-gray-400 text-sm leading-relaxed mt-12 max-w-3xl">
            The pattern is always the same: when competitors retreat, the cost
            of attention drops and the impact of visibility multiplies. The
            businesses that show up during the hard times own the recovery.
          </p>
        </div>
      </section>
      ...
      >
        <div className="max-w-5xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div>
            ...
            <div className="text-gray-500 text-sm">
              More brand visibility for businesses that maintain presence during
              a downturn.
            </div>
          </div>
          <div>
            ...
            <div className="text-gray-500 text-sm">
              Drop in ad spending during 2020 recession — creating a vacuum the
              bold brands filled.
            </div>
          </div>
          <div>
            ...
            <div className="text-gray-500 text-sm">
              Faster recovery for advertising brands that maintained visibility
              through the 1930s crisis.
            </div>
          </div>
        </div>
      </section>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 py-20">
          ...
          <p className="text-gray-400 text-sm mb-12">
            Two ways to make sure your business is still standing — and stronger
            — when this is done.
          </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            >
              ...
              <p className="text-blue-200 text-sm mb-6">
                <span className="line-through text-blue-300 mr-2">
                  BD 1,200+
                </span>{" "}
                Save up to 50%
              </p>
              <ul className="space-y-3 text-sm text-blue-100">
                {[
                  ...
                  <li key={i} className="flex gap-2">
                    <span className="text-blue-300 mt-0.5 flex-shrink-0">
                      ✓
                    </span>
                    <span>{item}</span>
                  </li>
            ...
            >
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-4">
                We&apos;re giving 3 Bahrain businesses a complimentary
                short-form video package — 3 videos. Half-day production day
                with two videographers.
              </p>
              <p className="text-gray-400 text-sm leading-relaxed mb-4">
                Tell us about your business. We&apos;ll select 3 businesses
          ...
          {[
            {
              ...
              sub: "Certified Google Ads partner",
            },
            {
              icon: "📅",
              label: "10+ Years Experience",
              sub: "Agency founded in 2012",
            },
            {
              icon: "👥",
              label: "30+ Team Members",
              sub: "In-house specialists",
            },
            {
              icon: "⭐",
              label: "Leading GCC Brands",
              sub: "Trusted by 200+ businesses",
            },
          ].map((b, i) => (
            <div key={i}>
      ...
      >
        <div className="max-w-3xl mx-auto px-6 py-20">
          ...
          <p className="text-gray-400 text-sm text-center mb-10">
            ...
            discuss the best option for your business.
          </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                  ...
                  <div
                    className="flex rounded border overflow-hidden focus-within:border-blue-500"
              ...
              <div>
                ...
                <select
                  ...
                  style={{
                    backgroundColor: "#1a1a1a",
                    borderColor: "#333",
                    color: formData.interested ? "#fff" : "#666",
                  }}
                >
              ...
              <button
                ...
                style={{
                  backgroundColor: status === "pending" ? "#1a5fa8" : "#2979ff",
                }}
              >
                {status === "pending"
                  ? "SUBMITTING..."
                  : "Show Up — Send My Details ↓"}
              </button>

              <p className="text-gray-600 text-xs text-center">
                We respect your privacy. Your info will only be used to contact
                you about this offer. Bahrain based business required. Limited
                slots available.
              </p>
            </form>
          )}
